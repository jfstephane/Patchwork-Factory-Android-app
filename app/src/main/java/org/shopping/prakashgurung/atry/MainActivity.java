...
//        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_gallery) {
            ...
            Uri uri = Uri.parse("https://www.patchworkfactory.co");
            Intent myAppLinkToMarket = new Intent(Intent.ACTION_VIEW, uri);
            try {
                startActivity(myAppLinkToMarket);
            } catch (ActivityNotFoundException e) {
                Toast.makeText(this, "unable", Toast.LENGTH_LONG).show();
            }
            ...
            i.putExtra(Intent.EXTRA_EMAIL  , new String[]{"annekerrieleveille@gmail.com"});
            i.putExtra(Intent.EXTRA_SUBJECT, "Report/Suggestions");
